...
describe('most blogs', () => { 
  ...
  test('when list has only one blog, is equal to one author and one blog', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(listWithOneBlog), { author: blogs[0].author, blogs: 1 })
  })
...
describe('most likes', () => { 
  ...
  test('when list has only one blog, is equal to one author and the likes on one blog', () => {
    assert.deepStrictEqual(listHelper.mostLikes(listWithOneBlog), { author: blogs[0].author, likes: blogs[0].likes })
  })
